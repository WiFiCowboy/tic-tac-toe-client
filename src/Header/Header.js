...
export default class Header extends Component {
  ...
  renderLeaderBoardLink() {
    return (
      <div className="leaderBoard">
        <Link onClick={this.handleLeaderboardClick} to="/leaderboard">
          Leaderboard
        </Link>
      </div>
    );
  ...
  renderLeaderBoardBackLink() {
    return (
      <div className="Header__logged-in leaderBoard">
        <Link onClick={this.handleLeaderboardClick} to="/">
          Back
        </Link>
      </div>
    );
  ...
  renderLeaderBoardStartGame() {
    return (
      <div className="Header__logged-in leaderBoard">
        <Link onClick={this.handleLeaderboardClick} to="/game">
          Game
        </Link>
      </div>
    );
  ...
  renderRegisterLink() {
    return (
      <div className="Header__not-logged-in leaderBoard">
  ...
  renderRegisterBackLink() {
    return (
      <div className="Header__logged-in leaderBoard">
        <Link onClick={this.handleRegisterClick} to="/">
          Back
        </Link>
      </div>
    );
    ...
    return (
      <>
        <nav className="Header">
          <div className="title">
            <h1>Tic-Tac-Toe Championship Edition</h1>
          </div>
